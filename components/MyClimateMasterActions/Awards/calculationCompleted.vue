...
<div>
    ...
    <div class="fixed-top h-100 w-100" style="background-color:rgba(247, 247, 247, 0.3);">
        <div class="col-md-6 mx-auto" style="margin-top:100px;">
           ...
           <!-- Congratulation1 -->
            <div id="id_div_congratulation_1_1" class="text-center bg-light border border-dark rounded w-100" style="position:absolute;left:0px;">
                <h2>Herzlichen Glückwunsch</h2>
                <h5>Der vermutlich schwierigste Schritt ist geschafft.</h5>
                ...
                <br>
                <p>Vielen Dank für die Berechnung deines CO2 Ausstoßes. Du findest deine aktuellste CO2 Berechnung auch immer unter "Mein Profil".</p>            
                <button class="btn btn-success mt-5 mb-3 px-5" v-on:click="nextCongratulation('id_div_congratulation_1_1', 'id_div_congratulation_1_2')">weiter</button>
            </div>
            <!-- Congratulation2 -->
            <div id="id_div_congratulation_1_2" class="text-center bg-light border border-dark rounded w-100 p-2" style="position:absolute;display:none;left:0px;">
...
export default {
    ...
    methods:{
        hideCongratulation(){
            this.$emit('hideCongratulation_calculationCompleted');
        },
