<template>
    <div class="container">
        <div class="container  mt-3 bg-light  rounded p-3">
            ...
            <div class="row">
                <div class="col-md-6 text-center mt-3" style="">
                    <h4>Unser Team</h4>
                    <img class="img-fluid" src="~/static/pictures/forSpecialSites/we/climatemaster_we_4.jpg" alt="Leider kein Bild gefunden">
                </div>
                <div class="col-md-6 text-center mt-3">
                    <h4>Unser Antrieb</h4>
                    <p class="mt-2 text-left">
                        Der Klimawandel stellt eine der größten Herausforderungen unserer Zeit dar, unsere Generation ist direkt 
                        von den Folgen einer globalen Erwärmung betroffen. An uns liegt es auch etwas zu verändern.<br>
                        ...
                        Jeder kann heute schon sehr klimafreundlich leben und damit die Zukunft folgender Generation verbessern.
                        ...
                        Die beste Rechtsform für solch eine Unternehmung wäre eine gemeinnützige Gesellschaft mit beschränkter Haftung (gGmbH).
...
<!-- 
        ...
        <!-- Impressum -->
        <div class="container  mt-3 mb-5 bg-light rounded p-3" style="">
            <div class="row">
                ...
                <div class="col-md-6 mt-3">
                    <h4 class="text-center">Dankeschön</h4>
