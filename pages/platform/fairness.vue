    ...
    <div class="container">
        <div class="container mt-3 col-md-10 bg-light  rounded p-3">
            ...
            <p>
                ...
                <span class="text-success">Climate</span>Master Handabdruck als reiche, weil Sie klimafreundlicher leben.</b> 
                Die Plattform belohnt Klimaschutz und Vermeidung von Treibhausgasen transparent und unabhängig vom Vermögen. 
            </p>
        </div>
    </div>
</template>