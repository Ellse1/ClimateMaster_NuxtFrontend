    ...
    <div class="container">
        <div class="container mt-3 col-md-10 bg-light  rounded p-3">
            ...
            <div class="text-center">
                <img style="max-width:100%;" src="~/static/pictures/forSpecialSites/theplatform/aimOfThePlatform/aim.png"/>
                <figcaption>Abb. : Die verursachten Emissionen sinken (rot), während die jährlich vermiedenen Emissionen steigen (grün).</figcaption>
            </div>
            <p class="mt-2">
            ...
            <ol>
                <li class="mt-2">
                    <b>Bewusstseinsschaffung für konkrete, effiziente Lösungen</b><br>
                    Möglichst viele Personen sollen konkrete, möglichst effiziente Ideen von Klimaschutzmöglichkeiten bekommen. 
                    Die Frage: “Was kann ich gegen den Klimawandel tun” soll konkret und individuell beantwortet werden. 
                    Effizienz bedeutet bei Privatpersonen, mit individuellem, subjektiv geringstem Aufwand, maximale 
                    Treibhausgasreduktion zu erzielen.

                </li>
                <li class="mt-2">
                    <b>Handlungen</b><br>
                    Wir wollen erreichen, dass Personen klimafreundlich leben und sich klimafreundlich verhalten. 
                    Dafür sind Handlungen und Verhaltensänderungen notwendig. Diese wollen wir anregen, unterstützen 
                    und anerkennen.
                </li>
                <li class="mt-2">
                    ...
                    damit eine positive Einstellung und ein positives Gefühl zu Klimaschutz bekommen.
                </li>
            </ol>
        </div>
    </div>
