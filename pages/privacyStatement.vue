<template>
    <div>
        <div class="bg-light container mt-5">
            ...
            <p><span id="s3-t-firma"></span><br><span id="s3-t-ansprechpartner">Elias Singer</span><br><span id="s3-t-strasse">Schulstraße 34</span><br><span id="s3-t-plz">78337</span> <span id="s3-t-ort">Öhningen</span><br>elias.singer@online.de</p><p></p>
